...
/**
 * A function that indentifies and returns the current square of a give sudoku grid a row and col index
 * @param param0 Object with 9x9 sudoku Grid row index and col index
 * @returns 
 */
